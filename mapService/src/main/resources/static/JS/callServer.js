...
export async function getReviewToTourist (touristNm, userId){
    try{
        ...
        //review-service/api/
        const response = await fetch('http://localhost:18865/review-service/api/'+encodedTouristNm+'/review/'+userId,{
            method : 'GET' ,
            headers : {
                'Content-Type': 'application/json; charset=UTF-8',
            } ,
...
export async function saveReview (reviewModal){
    try{
        ...
        //review-service/api/
        const response = await fetch('http://localhost:18865/review-service/api/review',{
            method : 'POST' ,
            headers : {
                'Content-Type': 'application/json; charset=UTF-8',
            } ,
